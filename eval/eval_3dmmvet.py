...
from gpt_eval import gpt_get_average_score
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=argparse.FileType('r'), default="./eval/3d-mm-vet/answers/shapellm-13b-general-v1.0.jsonl")
    parser.add_argument("--gt-file", type=argparse.FileType('r'), default="./eval/3d-mm-vet/gt.jsonl")
    parser.add_argument("--output-file", type=str, default="./eval/3d-mm-vet/result.jsonl")
